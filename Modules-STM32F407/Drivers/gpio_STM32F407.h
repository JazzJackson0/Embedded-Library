...
//GPIO I
#define ADDR_GPIOI_MODE ( (GPIOx_MODE*) ((GPIOI) + 0x00) )
#define ADDR_GPIOI_OUTPUTTYPE ( (GPIOx_OUTPUTTYPE*) ((GPIOI) + 0x04) )
#define ADDR_GPIOI_OUTPUTSPEED ( (GPIOx_OUTPUTSPEED*) ((GPIOI) + 0x08) )
#define ADDR_GPIOI_PULLUP_PULLDOWN ( (GPIOx_PULLUP_PULLDOWN*) ((GPIOI) + 0x0C) )
#define ADDR_GPIOI_INPUT ( (GPIOx_INPUT*) ((GPIOI) + 0x10) )
#define ADDR_GPIOI_OUTPUT ( (GPIOx_OUTPUT*) ((GPIOI) + 0x14) )
#define ADDR_GPIOI_BIT_SETRESET ( (GPIOx_BIT_SETRESET*) ((GPIOI) + 0x18) )
#define ADDR_GPIOI_CONFIG_LOCK ( (GPIOx_CONFIG_LOCK*) ((GPIOI) + 0x1C) )
#define ADDR_GPIOI_ALTERNATE_FUNCT_LOW ( (GPIOx_ALTERNATE_FUNCT_LOW*) ((GPIOI) + 0x20) )
#define ADDR_GPIOI_ALTERNATE_FUNCT_HIGH ( (GPIOx_ALTERNATE_FUNCT_HIGH*) ((GPIOI) + 0x24) )
