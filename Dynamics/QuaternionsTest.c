...
void RotateByAngleTest() {
    ...
    q1.q2 = 3.0;
    q1.q3 = 4.0;
    RotateByAngle(&q1, 30.0);
    assert(cos((30.0 / 2) * degree2RadConvert) == q1.q0);
    assert(q1.q1 * sin( (30.0 / 2) * degree2RadConvert) == q1.q1);
    assert(q1.q2 * sin( (30.0 / 2) * degree2RadConvert) == q1.q2);
    assert(q1.q3 * sin( (30.0 / 2) * degree2RadConvert) == q1.q3);
}
...
void NormalizeQuaternionTest() {
    ...
    assert(q1.q0 /= sqrt( 1 - (1 - Get_QuaternionLength(q1))) == q1.q0);
    assert(q1.q1 /= sqrt( 1 - (1 - Get_QuaternionLength(q1))) == q1.q1);
    assert(q1.q2 /= sqrt( 1 - (1 - Get_QuaternionLength(q1))) == q1.q2);
    assert(q1.q3 /= sqrt( 1 - (1 - Get_QuaternionLength(q1))) == q1.q3);
}
