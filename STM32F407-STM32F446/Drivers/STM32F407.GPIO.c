...
GPIOx *const B = ADDR_GPIOA;
GPIOx *const C = ADDR_GPIOA;
GPIOx *const D = ADDR_GPIOA;
GPIOx *const E = ADDR_GPIOA;
GPIOx *const F = ADDR_GPIOA;
GPIOx *const G = ADDR_GPIOA;
GPIOx *const H = ADDR_GPIOA;
GPIOx *const I = ADDR_GPIOA;
