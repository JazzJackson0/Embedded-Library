...
static ODD_PORTSx* Get_OddPort(char port);
static EVEN_PORTSx* Get_EvenPort(char port);

//Global Variables-------------------------------------------------------
//Watchdog Timer (Turn Off)
WATCHDOG_CONTROL *const watchdog = ADDR_WATCHDOG_CONTROL;
//Ports
ODD_PORTSx *const PORT1 = ADDR_PORT1;
EVEN_PORTSx *const PORT2 = ADDR_PORT2;
ODD_PORTSx *const PORT3 = ADDR_PORT3;
EVEN_PORTSx *const PORT4 = ADDR_PORT4;
EVEN_PORTSx *const PORTJ = ADDR_PORTJ;
...
void Pin_Init(char port, uint8_t pinNum, E_PinType direction, E_FunctionType function, E_PullUpDown pUppDwn) {
	...
	if (port == '1' || port == '3' || port == '5' || port == '7' || port == '9' || port == '11') {
		ODD_PORTSx *const PORT = Get_OddPort(port);
		switch (pinNum) {
			case 0 : 
		...
		EVEN_PORTSx *const PORT = Get_EvenPort(port);
		switch (pinNum) {
